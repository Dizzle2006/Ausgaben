...
const INTERVIEW_FRAGEN = [
  // ── Block 1: Grunddaten ──────────────────────────────────────
  {
    ...
    typ: "choice",
    optionen: [
      { wert: "arbeitnehmer",   label: "Angestellte/r (kein Studium)" },
      { wert: "azubi",          label: "Auszubildende/r" },
      { wert: "student_dual",   label: "Duales Studium (Uni + Betrieb + evtl. Berufsschule)" },
      { wert: "student_trial",  label: "Studienintegrierte Ausbildung (z.B. BHH PVA: Uni + BS + Betrieb)" },
      { wert: "student_voll",   label: "Vollzeit-Student/in (ohne Ausbildungsvertrag)" },
      { wert: "selbststaendig", label: "Selbstständig / Freiberuflich" },
      { wert: "beides",         label: "Angestellt UND selbstständig" },
      { wert: "rente",          label: "Rente / Pension" },
    ],
  },
  {
    id: "familienstand",
    ...
    optionen: [
      ...
      { wert: "verheiratet", label: "Verheiratet / eingetragene Partnerschaft" },
      { wert: "geschieden",  label: "Geschieden / getrennt" },
    ],
  },
  // NEU: Feature 2 — Bundesland + Kirchenmitglied
  {
    ...
    optionen: [
      { label: "Bayern", wert: "BY" },
      { label: "Baden-Württemberg", wert: "BW" },
      { label: "Berlin", wert: "BE" },
      { label: "Brandenburg", wert: "BB" },
      { label: "Bremen", wert: "HB" },
      { label: "Hamburg", wert: "HH" },
      { label: "Hessen", wert: "HE" },
      { label: "Mecklenburg-Vorpommern", wert: "MV" },
      { label: "Niedersachsen", wert: "NI" },
      { label: "Nordrhein-Westfalen", wert: "NW" },
      { label: "Rheinland-Pfalz", wert: "RP" },
      { label: "Saarland", wert: "SL" },
      { label: "Sachsen", wert: "SN" },
      { label: "Sachsen-Anhalt", wert: "ST" },
      { label: "Schleswig-Holstein", wert: "SH" },
      { label: "Thüringen", wert: "TH" },
    ],
  },
  {
    id: "kirchenmitglied",
  ...
  // NEU: Feature 3 — Rückwirkende Steuererklärungen
  {
    ...
    optionen: [
      { label: "Alle abgegeben (kein Nachholbedarf)", wert: "alle" },
      { label: "1 Jahr offen",  wert: "1" },
      { label: "2 Jahre offen", wert: "2" },
      { label: "3 Jahre offen", wert: "3" },
      { label: "4 Jahre offen", wert: "4" },
    ],
  },
  ...
  // ── Block 2: Studium ─────────────────────────────────────────
  {
    ...
    typ: "choice",
    optionen: [
      { wert: "erst",          label: "Erststudium (Bachelor oder erstes Studium nach Schule)" },
      { wert: "zweit",         label: "Zweitstudium / Master (nach abgeschlossenem Erststudium)" },
      { wert: "weiterbildung", label: "Berufsbegleitende Weiterbildung mit Abschluss" },
    ],
  ...
  },
  {
    ...
    typ: "number", einheit: "Tage", min: 0, max: 365,
    hinweis: (a) => {
  ...
  },
  {
    ...
    typ: "number", einheit: "km", min: 0, max: 300,
    hinweis: (a) => {
      const yr = new Date().getFullYear();
      const K = (typeof getK === "function") ? getK(yr) : null;
      const satz = K ? (yr >= 2026 ? "0,38 €/km ab km 1" : "0,30 €/km bis 20 km · 0,38 €/km ab km 21") : "0,38 €/km";
  ...
  },
  {
    ...
    typ: "number", einheit: "km", min: 0, max: 300,
    hinweis: (a) => a.studium_typ === "erst"
      ? "Erststudium: Uni-Fahrtkosten sind Sonderausgaben (max. 6.000 € gesamt), nicht Werbungskosten."
      : "Zweitstudium/Master: Uni-Fahrtkosten sind Werbungskosten — voll absetzbar.",
    bedingung: (a) => ["student_dual", "student_trial", "student_voll"].includes(a.beschaeftigung),
  },
  ...
  // ── Block 3: Arbeit ──────────────────────────────────────────
  {
    ...
    typ: "number", einheit: "€", min: 0, max: 500000,
  ...
  },
  {
    ...
    typ: "number", einheit: "Tage", min: 0, max: 260,
  ...
  // ── Block 5b: Vermietung (§21 EStG / Anlage V+V) ───────────────
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 500000,
  ...
  },
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 100000,
  ...
  },
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 50000,
  ...
  },
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 200000,
  ...
  },
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 20000,
  ...
  // ── Block 5c: EÜR für Selbstständige (§4 Abs.3 EStG) ────────────
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 2000000,
  ...
  },
  {
    ...
    typ: "number", einheit: "€ / Jahr", min: 0, max: 1000000,
  ...
  },
  {
    ...
    typ: "choice",
    optionen: [
      { wert: 20, label: "GdB 20" },
      { wert: 30, label: "GdB 30" },
      { wert: 50, label: "GdB 50" },
      { wert: 70, label: "GdB 70" },
      { wert: 80, label: "GdB 80" },
      { wert: 100, label: "GdB 100" },
    ],
  ...
  // ── Lohnsteuerbescheinigung ──────────────────────────────────
  {
    ...
    typ: "number", einheit: "€", min: 0, max: 200000,
  ...
  },
  {
    ...
    typ: "number", einheit: "€", min: 0, max: 20000,
...
function TaxInterview({ receipts, investments, year, tweaks = {}, onClose }) {
  ...
  React.useEffect(() => {
    try {
      ...
      window.dispatchEvent(new CustomEvent("interview-answers-updated", { detail: answers }));
    } catch { /* quota etc. */ }
  }, [answers]);

  const fragen = React.useMemo(
    () => INTERVIEW_FRAGEN.filter((f) => !f.bedingung || f.bedingung(answers)),
    [answers]
  );
  ...
  if (done && showResult) {
    return (
      <InterviewResult
        ...
        year={year}
        tweaks={tweaks}
        onRestart={() => { setAnswers(initial); setCurrent(0); setDone(false); setShowResult(false); }}
        onClose={onClose}
      />
    );
  }
    ...
    <div className="tax-modal-backdrop" onClick={onClose}>
      <div className="tax-modal" onClick={(e) => e.stopPropagation()}>
        <div className="tax-modal-header">
          <div className="tax-modal-eyebrow">
            {frage.block} · Frage {current + 1} / {fragen.length}
          </div>
          {(() => {
        ...
        <div className="tax-modal-progress">
          <div className="tax-modal-progress-fill" style={{ width: `${progress}%` }} />
        </div>

        <div className="tax-modal-body">
          <h2 className="interview-frage">{frage.frage}</h2>
          {frage.hinweis && (
            <div className="interview-hinweis">
              {typeof frage.hinweis === "function" ? frage.hinweis(answers) : frage.hinweis}
            </div>
          )}
          ...
          {frage.typ === "number" && (
            <div className="interview-number">
              <div className="interview-number-row">
                <input
                  ref={numInputRef}
                  type="number"
                  min={frage.min ?? 0}
                ...
                />
                <span className="interview-einheit">{frage.einheit}</span>
              </div>
              <button
...
function LohnsteuerBescheinigungCard({ year }) {
  ...
  React.useEffect(() => {
    (async () => {
      try {
        ...
        if (entry?.dataUrl) { setHasImage(true); setPreview(entry.dataUrl); }
      } catch { /* ignore */ }
    })();
  }, [idbKey]);
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor"
            strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
            style={{ color: hasImage ? "oklch(0.52 0.14 145)" : "var(--text-faint)", flexShrink: 0 }}>
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
            <polyline points="14 2 14 8 20 8" />
          </svg>
          <span style={{ fontSize: 13, color: hasImage ? "oklch(0.34 0.13 145)" : "var(--text-muted)", fontWeight: 500 }}>
            {`Lohnsteuerbescheinigung ${year}${hasImage ? " — gespeichert ✓" : " — nicht hochgeladen"}`}
          </span>
        </div>
        <div style={{ display: "flex", gap: 6 }}>
          {hasImage && (
            <button
              ...
              style={{ fontSize: 11, padding: "3px 10px", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 8, cursor: "pointer", color: "var(--text-muted)" }}
            >
        ...
        <div style={{ marginTop: 10 }}>
          {isPdf ? (
            <div style={{ fontSize: 12, color: "var(--text-muted)", textAlign: "center", padding: 8 }}>
              PDF gespeichert (Vorschau nicht möglich)
            </div>
          ) : (
            <img src={preview} alt="Lohnsteuerbescheinigung"
...
function LohnsteuerUploadStep({ year, onContinue, onSkip }) {
  const idbKey = `lohnsteuerbescheinigung-${year}`;
  const [preview, setPreview] = React.useState(null);
  ...
  return (
    <div className="tax-modal-backdrop" onClick={onSkip}>
      <div className="tax-modal" onClick={(e) => e.stopPropagation()}>
        <div className="tax-modal-header">
          <div className="tax-modal-eyebrow">Optional · Lohnsteuerbescheinigung</div>
          <button className="settings-close" onClick={onSkip} aria-label="Überspringen">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <line x1="18" y1="6" x2="6" y2="18" />
              <line x1="6" y1="6" x2="18" y2="18" />
        ...
        <div className="tax-modal-body">
          <p style={{ fontSize: 14, color: "var(--text-muted)", marginBottom: 16, lineHeight: 1.5 }}>
            Lade deine Lohnsteuerbescheinigung als Foto oder PDF hoch — zur Archivierung.
            Sie wird lokal gespeichert und verlässt dein Gerät nicht.
          </p>
          ...
          {!preview ? (
            ...
            >
              {loading ? (
                <div style={{ color: "var(--text-muted)", fontSize: 13 }}>Wird gespeichert…</div>
              ) : (
                <React.Fragment>
                  ...
                  <div style={{ fontSize: 13, color: "var(--text-muted)" }}>Foto oder PDF ausw&#228;hlen</div>
                  <div style={{ fontSize: 11, color: "var(--text-faint)", marginTop: 4 }}>
                    JPG, PNG oder PDF · wird nur lokal gespeichert
                  </div>
                </React.Fragment>
              )}
              <input ref={inputRef} type="file" accept="image/*,application/pdf"
            ...
            <div style={{ position: "relative" }}>
              {isPdf ? (
                <div style={{ background: "var(--surface-2)", borderRadius: 10, padding: "24px 16px", textAlign: "center", color: "var(--text-muted)", fontSize: 13 }}>
                ...
                <img src={preview} alt="Lohnsteuerbescheinigung"
                  style={{ width: "100%", borderRadius: 10, maxHeight: 220, objectFit: "contain", background: "var(--surface-2)" }} />
              )}
              <button
                onClick={handleDelete}
                style={{ position: "absolute", top: 8, right: 8, background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 8, padding: "4px 10px", fontSize: 11, color: "var(--text-muted)", cursor: "pointer" }}
              >
                Entfernen
              </button>
              {saved && (
                <div style={{ marginTop: 8, fontSize: 12, color: "oklch(0.52 0.14 145)", textAlign: "center" }}>
                  {"✓"} Lokal gespeichert
                </div>
              )}
            </div>
          ...
          <div className="tax-modal-actions" style={{ marginTop: 20 }}>
            <button className="receipt-btn secondary" onClick={onSkip}>Überspringen</button>
            <button className="receipt-btn primary" onClick={onContinue}>
...
function AusgeschlossenesAccordion({ positionen }) {
  ...
  return (
    <div style={{ marginBottom: 12 }}>
      ...
      >
        <span>{open ? "▲" : "▼"}</span>
        <span>{positionen.length} Position{positionen.length > 1 ? "en" : ""} gilt nicht für dich</span>
      </button>
      {open && (
        <div style={{ marginTop: 6, display: "flex", flexDirection: "column", gap: 6 }}>
          {positionen.map((p) => (
            <div key={p.id} style={{
              ...
              <div style={{ fontSize: 12, color: "oklch(0.55 0.16 50)", lineHeight: 1.45 }}>
                ⚠ {p.grund}
              </div>
            </div>
          ))}
...
function InterviewResult({ answers, receipts, investments, year, tweaks, onRestart, onClose }) {
  const y = String(year);

  const profile = React.useMemo(
    () => typeof buildUserProfile === "function" ? buildUserProfile(answers, tweaks) : null,
    [answers, tweaks]
  );
  ...
  const ersparnisGesamt = ops
    .filter((o) => !o.istGeschaetzt && (o.ersparnis || 0) > 0)
    .reduce((s, o) => s + (o.ersparnis || 0), 0);
  ...
  const exportCSV = () => {
    ...
    for (const op of ops) {
      const eur = (op.ersparnis || 0) > 0
        ? op.ersparnis.toFixed(2).replace(".", ",")
        : "(Prüfen)";
  ...
  const OpCard = ({ op }) => (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
        <span style={{ fontSize: 14, fontWeight: 700, color: "var(--text)" }}>{op.titel}</span>
        {(op.ersparnis || 0) > 0 && (
          <span style={{
            fontSize: 14, fontWeight: 800, color: "oklch(0.5 0.14 145)",
  ...
  return (
    <div className="tax-modal-backdrop" onClick={onClose}>
      <div className="tax-modal" onClick={(e) => e.stopPropagation()}>
        <div className="tax-modal-header">
          <h2 className="tax-modal-title">Steuerberatung {year}</h2>
          <button className="settings-close" onClick={onClose} aria-label="Schließen">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <line x1="18" y1="6" x2="6" y2="18" />
        ...
        <div className="tax-modal-body">
          <LohnsteuerBescheinigungCard year={year} />

          {/* Anlage V+V — nur für Vermieter */}
          {answers.vermieter === true && typeof window.VermietungCard === "function" && (
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: "var(--text-faint)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 8 }}>
                Anlage V+V — Vermietung &amp; Verpachtung
              </div>
              {React.createElement(window.VermietungCard, { interviewAnswers: answers, year })}
            </div>
          )}

          {/* Anlage EÜR — nur für Selbstständige */}
          {["selbststaendig", "beides"].includes(answers.beschaeftigung) && typeof window.EUERCard === "function" && (
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: "var(--text-faint)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 8 }}>
                Anlage EÜR — Einnahmen-Überschuss-Rechnung
              </div>
              {React.createElement(window.EUERCard, { interviewAnswers: answers, receipts, year })}
            </div>
          )}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 18 }}>
            <div className="opt-metric">
              <div className="opt-metric-label">Gesichertes Potenzial</div>
              <div className="opt-metric-value success">
                {ersparnisGesamt > 0 ? fmtEUR(ersparnisGesamt) : "—"}
              </div>
            </div>
            <div className="opt-metric">
              <div className="opt-metric-label">Positionen</div>
              <div className="opt-metric-value action">{lohntEinzeln.length + zuPruefen.length}</div>
            </div>
          </div>

          {/* Was du geltend machen kannst */}
          {(lohntEinzeln.length + zuPruefen.length) > 0 && (
            <div style={{ marginBottom: 14 }}>
              <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {hinweise.map((op) => (
                  <div key={op.id} style={{
                    ...
                    <div style={{ fontSize: 13, fontWeight: 600, color: "var(--text)" }}>{op.titel}</div>
          ...
          <AusgeschlossenesAccordion positionen={ausgeschlossen} />

          {ops.length === 0 && ausgeschlossen.length === 0 && (
            <div style={{
              textAlign: "center", padding: "28px 18px",
              color: "var(--text-muted)", fontSize: 14,
            }}>
              Keine Positionen gefunden. Gib mehr Daten ein oder erfasse Belege im Scanner-Tab.
            </div>
          )}
          ...
          <div style={{
            ...
            fontSize: 11.5, color: "var(--text-faint)", lineHeight: 1.5,
          }}>
            Alle Angaben vereinfacht — keine Steuerberatung. Werte manuell in ELSTER prüfen.
          </div>

          <div className="tax-modal-actions" style={{ marginTop: 16 }}>
            <button className="receipt-btn secondary" onClick={onRestart}>Neu starten</button>
            <button className="receipt-btn primary" onClick={exportCSV}>CSV exportieren</button>
          </div>
        </div>
      </div>
    </div>
